...
export default {
  ...
  config: {
    ...
    pages: ['^pages/index/main', 'pages/search/main', 'pages/charts/main', 'pages/topic/main', 'pages/user/main', 'pages/user-edit/main', 'pages/user-topic/main', 'pages/user-message/main', 'pages/user-info-card/main', 'pages/topic-detail/main', 'pages/user-setting/main', 'pages/about-alumni/main', 'pages/system-message-detail/main'],
