<template>
  <div>
    <div class="switch-tab">
      <div class="switch-item" :class="{'active':currentTab === '1'}" @click="clickTab('1')">个人消息</div>
      <div class="switch-item" :class="{'active':currentTab === '2'}" @click="clickTab('2')">系统消息</div>
    </div>
