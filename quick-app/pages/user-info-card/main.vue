  ...
  <div class="user-card-main">
    ...
    <div class="user-card-content">
      <div class="user-card-item">
        <div class="user-card-item-icon">
          <span class="aliiconfont card-item-icon">&#xe955;</span>
        </div>
        <div class="user-card-item-content">
          {{ userInfo.school.university }}
        </div>
      </div>
      <div class="user-card-item">
        <div class="user-card-item-icon">
        ...
        <div class="user-card-item-content">
          {{
            userInfo.school.graduationTime
              ? userInfo.school.graduationTime
              : '暂无'
          }}@{{ userInfo.school.college ? userInfo.school.college : '暂无' }}
          {{ userInfo.school.major ? userInfo.school.major : '暂无' }}专业
        </div>
      </div>
    </div>
    <!--联系方式-->
    <div class="user-card-contact">
      <div class="user-card-item" @click="saveToPhoneBook()">
        ...
        <div class="user-card-item-content">
          ...
          <span class="user-card-more-action" v-if="userInfo.phone"
            >保存到通讯录</span
          >
        </div>
      </div>
      <div class="user-card-item">
        ...
        <div class="user-card-item-content">
          {{ userInfo.wechat ? userInfo.wechat : '暂无' }}
          <span
            class="user-card-more-action"
    ...
    <div class="user-card-job">
      <div class="user-card-item">
        ...
        <div class="user-card-item-content">
          {{ userInfo.company ? userInfo.company : '暂无' }}
        </div>
      </div>
      <div class="user-card-item">
        <div class="user-card-item-icon">
