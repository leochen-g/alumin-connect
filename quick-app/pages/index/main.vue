    ...
    <div class="schoolMain">
      <div class="school-info">
        ...
        <div class="button-finish">
          <button v-if="university !== ''" class="finish" @click="goCharts">
            查看足迹
          </button>
          <button v-if="university === ''" class="finish" @click="saveTips">
            查看足迹
          </button>
        </div>
		<ad unit-id="adunit-1e7e4bd2b149e4c8" ad-type="video" ad-theme="white"></ad>
      </div>
    </div>
  </div>
</template>
    ...
    goCharts: function () {
		...
		if (wx.createRewardedVideoAd) {
		  videoAd = wx.createRewardedVideoAd({
		    adUnitId: 'adunit-ae31819943efb919'
		  })
		  videoAd.onLoad(() => {})
		  videoAd.onError((err) => {
...
.schoolMain {
  ...
  background-image: url('https://img.aibotk.com/pubilc/cdn/bg1.jpeg');
