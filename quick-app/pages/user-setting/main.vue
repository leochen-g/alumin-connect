    ...
    <div class="setting-main">
      <div class="setting-content">
        <div class="setting-info-item">
          <button class="setting-item-title alumni-btn" open-type="contact">
            帮助
          </button>
        </div>
        <div class="setting-info-item">
          <button class="setting-item-title alumni-btn" open-type="feedback">
            反馈
          </button>
        </div>
        <div class="setting-info-item">
          <button class="setting-item-title alumni-btn" open-type="share">
            分享给好友
          </button>
        </div>
        ...
        <div class="setting-info-item">
          <button class="setting-item-title alumni-btn" @click="clickToCopy()">
            校友助手微信号
          </button>
        </div>
      </div>
