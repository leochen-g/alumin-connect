          ...
          <div class="edit-item">
            ...
            <div class="edit-btn-group" v-if="type === 'nickName'">
              <a
                href=""
                class="save"
                @click="updateUserInfo('nickName', userInfo.nickName)"
                >保存</a
              >
          ...
          <div class="edit-item">
            ...
            <div class="edit-btn-group" v-if="type === 'wechat'">
              <a
                href=""
                class="save"
                @click="updateUserInfo('wechat', userInfo.wechat)"
                >保存</a
              >
              <a href="" class="cancel" @click="cancel">取消</a>
            </div>
          ...
          <div class="edit-item">
            ...
            <div class="edit-btn-group" v-if="type === 'phone'">
              <a
                href=""
                class="save"
                @click="updateUserInfo('phone', userInfo.phone)"
                >保存</a
              >
              <a href="" class="cancel" @click="cancel">取消</a>
            </div>
        ...
        <div v-if="editType === 'school'">
          <div class="edit-item">
            ...
            <div class="edit-input">
              <input
                type="text"
                v-model="userInfo.school.university"
                @click="goSearchSchool()"
              />
            </div>
          </div>
          <div class="edit-item">
            ...
            <div class="edit-input">
              <picker
                mode="date"
                :value="userInfo.school.graduationTime"
                fields="year"
          ...
          <div class="edit-item">
            ...
            <div class="edit-input">
              <input
                type="text"
                v-model="userInfo.school.college"
                @click="focusClick('college')"
                @blur="moveClick"
              />
            </div>
            <div class="edit-btn-group" v-if="type === 'college'">
              <a
                ...
                class="save"
                @click="
                  updateUserInfo('college', userInfo.school.college, 'school')
                "
                >保存</a
              >
              <a href="" class="cancel" @click="cancel">取消</a>
          ...
          <div class="edit-item">
            ...
            <div class="edit-input">
              <input
                type="text"
                v-model="userInfo.school.major"
                @click="focusClick('major')"
                @blur="moveClick"
              />
            </div>
            <div class="edit-btn-group" v-if="type === 'major'">
              <a
                ...
                class="save"
                @click="
                  updateUserInfo('major', userInfo.school.major, 'school')
                "
                >保存</a
              >
              <a href="" class="cancel" @click="cancel">取消</a>
          ...
          <div class="edit-item">
            ...
            <div class="edit-btn-group" v-if="type === 'company'">
              <a
                href=""
                class="save"
                @click="updateUserInfo('company', userInfo.company)"
                >保存</a
              >
              <a href="" class="cancel" @click="cancel">取消</a>
            </div>
          ...
          <div class="edit-item">
            ...
            <div class="edit-btn-group" v-if="type === 'job'">
              <a
                href=""
                class="save"
                @click="updateUserInfo('job', userInfo.job)"
                >保存</a
              >
              <a href="" class="cancel" @click="cancel">取消</a>
            </div>
