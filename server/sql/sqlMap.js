var sqlMap = {
  ...
  group: {
	...
	getReplyList:'select count(id) as count from reply where cid=? and flag=1;select a.*, b.avataUrl, b.college, b.graduationTime, b.location, b.major, b.nickName, b.university, c.nickName as respNickName from reply a inner join user b on a.openId = b.openid inner join user c on a.toUid = c.openid where cid=? and flag=1 order by id desc limit 0,2',
	getReplyListNoLimit:'select count(id) as count from reply where cid=? and flag=1;select a.*, b.avataUrl, b.college, b.graduationTime, b.location, b.major, b.nickName, b.university, c.nickName as respNickName from reply a inner join user b on a.openId = b.openid inner join user c on a.toUid = c.openid where cid=? and flag=1 order by id desc',
	user:{
